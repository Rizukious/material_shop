...
class Barang extends CI_Controller
{
    ...
    {
        $data['title'] = "Barang";
        $data['barang'] = $this->main->getBarang();
    ...
    public function add()
    {
        $kdBarang = generate_id("B", "barang", "kdBarang", "", 4);

        $data = [
            'title'     => 'Barang',
            'kategori'  => $this->main->get('kategori'),
            'satuan'    => $this->main->get('satuan'),
            'kdBarang'  => $kdBarang
        ];
    ...
    public function edit($getId)
    {
        ...
        $data = [
            ...
            'kategori'  => $this->main->get('kategori'),
            'satuan'    => $this->main->get('satuan'),
            'barang'    => $this->main->get_where('barang', $where),
            'kdBarang'  => $id
        ];
